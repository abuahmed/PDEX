...
namespace PDEX.WPF.ViewModel
{
    public class UserViewModel : ViewModelBase
    {
        ...
        {
            get { return _addNewUserViewCommand ?? (_addNewUserViewCommand = new RelayCommand(ExecuteAddNewUserViewCommand)); }
        }
        ...
        {
            get { return _saveUserViewCommand ?? (_saveUserViewCommand = new RelayCommand(ExecuteSaveUserViewCommand, CanSave)); }
        }
        private void ExecuteSaveUserViewCommand()
        {
            try
            {
                ...
                if (SelectedUser.UserId == 0)
                {
                    ...
                    var membershipDTO = new UserService().GetAllMemberShips().FirstOrDefault(m => m.UserId == SelectedUser.UserId);
        ...
        {
            get { return _deleteUserViewCommand ?? (_deleteUserViewCommand = new RelayCommand(ExecuteDeleteUserViewCommand)); }
        }
        ...
        {
            get { return _closeUserViewCommand ?? (_closeUserViewCommand = new RelayCommand<Object>(ExecuteCloseUserViewCommand)); }
        }
        ...
        {
            get { return _deleteRoleViewCommand ?? (_deleteRoleViewCommand = new RelayCommand(ExecuteRemoveRoleViewCommand)); }
        }
        ...
        public ICommand GetNewPassword
        {
            get
            {
                return _getNewPassword ?? (_getNewPassword = new RelayCommand(ExcuteGetNewPassword));
            }
        }
        ...
        private void GetLiveRoles()
        {
            ...
            Roles = new ObservableCollection<RoleDTO>(Roles.Skip(5));
        }
        #endregion
