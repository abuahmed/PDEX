...
namespace PDEX.WPF.ViewModel
{
    public class BackupRestoreViewModel : ViewModelBase
    {
        ...
        //    if (Singleton.Edition == PDEXEdition.ServerEdition)
        //    {
        ...
        //            var destFileName = "PDEXDb_" + DateTime.Now.ToLongDateString() + "_Backup.sdf";
        ...
        //                    var pathfile = Path.Combine(path, "PDEXDb_" + DateTime.Now.Ticks.ToString() + ".sdf");
        ...
        //                    var bkpDatabase = new Backup { Action = BackupActionType.Database, Database = "PDEXDb" };
        ...
        //            {
        //                //this.Cursor = Cursors.WaitCursor;                            
        //                var rstDatabase = new Restore { Action = RestoreActionType.Database, Database = "PDEXDb" };
